...
Creating a user:
```{python}
"""api_url = "http://localhost:5000/create_user"

# Data to be sent in the POST request
song_data1 = {
    "user_name": "musical_musician_25",
    "password": "abcde",
}
song_data2 = {
    "user_name": "musical_musician_25",
...
if response.status_code == 201:
    print("Song added successfully")
    print(response.json())  # Assuming the response is in JSON format
    data = api_query(endpoint, "/songs?album=1989")
    print(data)
else:
    print(f"Error: {response.status_code} - {response.text}")

print("Adding a song to album 2 will not work because album 2 is not our album")
response = requests.post(api_url, json=song_data2)
# Check the response
if response.status_code == 201:
    print("Song added successfully")
...
api_url = "http://localhost:5000/delete_song/481"
...
```{python}
api_url = "http://localhost:5000/update_song/481"
